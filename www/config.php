...
echo "
<link rel='stylesheet' href='http://127.0.0.1:9999/framework/style.css' />",
"
...
echo "<div class='trigger' style='border-color: var(--{$color}); color:var(--{$color});'>[ Linha {$line} ]
    {$message}<small>{$file}</small></div>";
}